...
Get the AgentECHO backend running in under 5 minutes.
...
```bash
docker exec agentecho-clickhouse clickhouse-client \
...
See the main [AgentECHO Server README](../README.md#-api-reference) for complete endpoint documentation.
