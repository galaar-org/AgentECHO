...
AgentECHO is a Next.js 16 dashboard for visualizing and analyzing AI bot traffic patterns across web routes. The frontend consumes a REST API backend for real-time traffic analytics.
