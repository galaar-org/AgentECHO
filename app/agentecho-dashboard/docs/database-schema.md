...
The AgentECHO dashboard is a frontend application that consumes data from an external API backend. This document describes the data models used in the frontend and the expected schema from the API.
