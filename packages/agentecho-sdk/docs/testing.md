...
This document describes how to run and write tests for AgentECHO.
...
AgentECHO emphasizes unit tests for core logic:
...
AgentECHO is a client SDK - E2E tests belong in consuming applications.
...
```json
{
  ...
  "cwd": "${workspaceFolder}/packages/agentecho-core"
}
```
