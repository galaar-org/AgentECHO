...
This document outlines procedures for responding to incidents related to the AgentECHO SDK.
...
```typescript
// Emergency bypass - disable AgentECHO temporarily
...
```bash
# View package info
npm view @galaar/agentecho-core

# Check for vulnerabilities
npm audit

# View download stats
npm show @galaar/agentecho-core downloads
```
