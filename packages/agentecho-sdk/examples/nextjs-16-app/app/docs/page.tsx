...
export default function DocsPage() {
	return (
		<div className="min-h-screen bg-zinc-50">
			...
			<ProseLayout
				title="Documentation"
				description="Learn how to integrate AgentECHO and build your analytics backend."
			>
				<H2>Architecture Overview</H2>
				<P>AgentECHO consists of two parts:</P>
				<UL>
					<LI>
				...
				<Table>
					...
					<tbody>
						<tr>
							<TD>
								<Code>x-agentecho-key-id</Code>
							</TD>
							<TD>Key identifier</TD>
						</tr>
						<tr>
							<TD>
								<Code>x-agentecho-ts</Code>
							</TD>
							<TD>Unix timestamp (ms)</TD>
						</tr>
						<tr>
							<TD>
								<Code>x-agentecho-signature</Code>
							</TD>
