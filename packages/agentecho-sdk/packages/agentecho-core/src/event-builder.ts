import type { EventBuilder as EventBuilderInterface, EventData, AgentECHOEvent } from './types';
...
export class EventBuilder implements EventBuilderInterface {
  ...
  build(data: EventData): AgentECHOEvent {
    return {
  ...
  private extractOptionalFields(data: EventData): Partial<AgentECHOEvent> {
    const fields: Partial<AgentECHOEvent> = {};
