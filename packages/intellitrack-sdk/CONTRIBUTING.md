...
Thank you for your interest in contributing to IntelliTrack! This document provides guidelines for contributing to the project.
...
2. Clone your fork:
   ```bash
   git clone https://github.com/YOUR_USERNAME/intellitrack-sdk.git
   cd intellitrack-sdk
   ```
...
- `core`: Changes to `@intellitrack/core`
- `nextjs`: Changes to `@intellitrack/nextjs`
...
```bash
# Core
cd packages/intellitrack-core && pnpm test

# Next.js adapter
cd packages/intellitrack-nextjs && pnpm test
```
...
intellitrack-sdk/
├── packages/
│   ├── intellitrack-core/      # Core SDK (framework-agnostic)
│   │   ├── src/                # Source files
│   │   └── test/               # Tests
...
- **Core SDK logic**: `packages/intellitrack-core`
- **Next.js specific**: `packages/intellitrack-nextjs`
- **New framework adapter**: `packages/intellitrack-{framework}`
- **Documentation**: `docs/`
...
1. Create package directory:
   ```bash
   mkdir packages/intellitrack-{framework}
   ```

2. Set up package structure:
   ```
   intellitrack-{framework}/
   ├── package.json
   ├── tsconfig.json
   ├── vitest.config.ts
   ├── src/
...
4. Implement adapter using `@intellitrack/core`
