...
| Package | Description |
|---------|-------------|
| [@intellitrack/core](./packages/intellitrack-core) | Framework-agnostic core SDK |
| [@intellitrack/nextjs](./packages/intellitrack-nextjs) | Next.js 15+ adapter |
...
```
POST /v1/events
x-intellitrack-key-id: prod-key-1
x-intellitrack-ts: 1703001234567
x-intellitrack-signature: base64url-encoded-hmac
```
