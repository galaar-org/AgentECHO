...
const tracker = createIntelliTrackClient({
...
Headers sent:
- `x-intellitrack-key-id` — Key identifier
- `x-intellitrack-ts` — Unix timestamp (ms)
- `x-intellitrack-signature` — Base64url signature
