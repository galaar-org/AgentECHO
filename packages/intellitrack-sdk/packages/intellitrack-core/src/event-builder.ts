import type { EventBuilder as EventBuilderInterface, EventData, IntelliTrackEvent } from './types';
...
export class EventBuilder implements EventBuilderInterface {
  ...
  private extractOptionalFields(data: EventData): Partial<IntelliTrackEvent> {
    const fields: Partial<IntelliTrackEvent> = {};
