...
export default function DocsPage() {
	return (
		<div className="min-h-screen bg-zinc-50">
			...
			<ProseLayout
				title="Documentation"
				description="Learn how to integrate IntelliTrack and build your analytics backend."
			>
				<H2>Architecture Overview</H2>
				<P>IntelliTrack consists of two parts:</P>
				<UL>
					<LI>
				...
				<Table>
					...
					<tbody>
						<tr>
							<TD>
								<Code>x-intellitrack-key-id</Code>
							</TD>
							<TD>Key identifier</TD>
						</tr>
						<tr>
							<TD>
								<Code>x-intellitrack-ts</Code>
							</TD>
							<TD>Unix timestamp (ms)</TD>
						</tr>
						<tr>
							<TD>
								<Code>x-intellitrack-signature</Code>
							</TD>
