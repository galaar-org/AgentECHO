# IntelliTrack Next.js Example

Working example of IntelliTrack integrated with Next.js 16 using `proxy.ts`.
...
```
├── proxy.ts          # IntelliTrack integration
├── app/
│   ├── layout.tsx
│   ├── page.tsx
│   └── ...
...
```
[IntelliTrack] Initialized: { ... }
[IntelliTrack] Scheduled: /
[IntelliTrack] Captured: abc-123-...
```
