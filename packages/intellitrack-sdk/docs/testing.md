...
This document describes how to run and write tests for IntelliTrack.
...
# Next.js adapter
cd packages/intellitrack-nextjs
pnpm test
```
...
IntelliTrack emphasizes unit tests for core logic:
...
IntelliTrack is a client SDK - E2E tests belong in consuming applications.

## Coverage Expectations

| Package | Target Coverage |
|---------|----------------|
| `intellitrack-core` | 90%+ |
| `intellitrack-nextjs` | 80%+ |
...
```json
{
  ...
  "cwd": "${workspaceFolder}/packages/intellitrack-core"
}
```
